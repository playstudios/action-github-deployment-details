...
function parseDeploymentJson(buffer) {
    ...
    return {
        ...
        application: ((_a = payload) === null || _a === void 0 ? void 0 : _a.application) || '',
        valuesFile: ((_b = payload) === null || _b === void 0 ? void 0 : _b.values_file) || '',
        keyPaths: ((_c = payload) === null || _c === void 0 ? void 0 : _c.key_paths) || '',
